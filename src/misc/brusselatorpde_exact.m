function brusselatorpde_exact()  
    ...
    filename = "./../resources/BrusselatorPDE/brusselatorpde_t.csv";
    writematrix(t, filename);
    filename = "./../resources/BrusselatorPDE/brusselatorpde_truesol.csv";
    ...
    filename = "./../resources/BrusselatorPDE/brusselatorpde_fixed_t.csv";
    writematrix(t, filename);
    filename = "./../resources/BrusselatorPDE/brusselatorpde_fixed_truesol.csv";
    writematrix(y', filename);
    ...
    filename = "./../resources/BrusselatorPDE/brusselatorpde_fixed_t_11.csv";
    writematrix(t, filename);
    filename = "./../resources/BrusselatorPDE/brusselatorpde_fixed_truesol_11.csv";
    writematrix(y', filename);
end
