function brusselatorpde201_exact()  
    tspan = 0:(3/10):3;
    n = 201;
    y0 = get_y0(n);
    ...
    filename = "./../resources/BrusselatorPDE201/BrusselatorPDE201_t.csv";
    writematrix(t, filename);
    filename = "./../resources/BrusselatorPDE201/BrusselatorPDE201_truesol.csv";
    ...
    filename = "./../resources/BrusselatorPDE201/BrusselatorPDE201_fixed_t.csv";
    writematrix(t, filename);
    filename = "./../resources/BrusselatorPDE201/BrusselatorPDE201_fixed_truesol.csv";
    writematrix(y', filename);
    ...
    filename = "./../resources/BrusselatorPDE201/BrusselatorPDE201_fixed_t_11.csv";
    writematrix(t, filename);
    filename = "./../resources/BrusselatorPDE201/BrusselatorPDE201_fixed_truesol_11.csv";
    writematrix(y', filename);
end
