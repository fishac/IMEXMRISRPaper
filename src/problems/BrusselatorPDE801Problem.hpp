#ifndef BRUSSELATORPDE801PROBLEM_DEFINED__
#define BRUSSELATORPDE801PROBLEM_DEFINED__
...
class BrusselatorPDE801Problem : public Problem {
public:
	int n = 0;
	double dx = 0.0;
	int u_start = 0;
	...
	BrusselatorPDE801Problem() {
		name = "BrusselatorPDE801";
		n = 801;
